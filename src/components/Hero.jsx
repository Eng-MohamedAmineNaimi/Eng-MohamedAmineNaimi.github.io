    ...
    >
      ...
      >
        ...
        <div className="flex flex-col w-full">
          {/* Greeting aligné à gauche en français, à droite en arabe */}
          <h1
            className={`${styles.heroSubText} mt-0 text-[#7A238A] ${
          ...
          {/* Nom centré en arabe, sinon aligné à gauche */}
          <h1
            className={`${styles.heroHeadText} text-white ${
              isRtl ? "text-center" : "text-left"
            }`}
          >
            <span className="text-[26px] sm:text-[32px] md:text-[80px] font-bold">
              {name}
            </span>
          </h1>
        </div>
